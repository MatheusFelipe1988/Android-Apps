...
#define TAG "AcessFileApp - C++"

extern "C" JNIEXPORT jstring JNICALL

Java_com_vendor_accessfiler_MainActivity_readFile(
        JNIEnv *env,
        jobject,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vendor_accessfiler_MainActivity_writeFile(
        JNIEnv *env,
        jobject,
        jstring yourFilepath,
        jstring jtext) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vendor_accessfiler_MainActivity_removeFile(
        JNIEnv *env,
        jobject,
        jstring yourFilepath) {
